...
프론트엔드 지식 관련 참고 링크들을 모아둔 페이지입니다.
...
## 프로젝트 구조 및 아키텍처
- [Toss | react-simplikit](https://github.com/mslee98/react-simplikit)
- [Toss | react-simplikit Docs](https://react-simplikit.slash.page/ko/intro.html)
    -  프로젝트 구조 및 공통 hook 유틸 참고 좋음
